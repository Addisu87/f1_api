class CircuitsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @circuit.update(circuit_params)
        format.html { redirect_to @circuit, notice: "Circuit was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to circuits_path, notice: "Circuit was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def circuit_params
      params.expect(circuit: [ :name, :location ])
    end
end
